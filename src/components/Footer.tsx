        ...
        <div className="glass-effect rounded-2xl shadow-pink border-2 border-pink-100 p-6">
          <p className="text-gray-700 mb-2">
            ...
            <a
              ...
              className="font-bold bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent hover:from-pink-700 hover:to-rose-700 transition-all duration-300"
            >
              Polina Proger
            </a>
          </p>
